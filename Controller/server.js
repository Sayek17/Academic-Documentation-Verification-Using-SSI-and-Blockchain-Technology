...
app.post("/checkMemName", function (req, res) {
  ...
  axios
    .get("http://127.0.0.1:8021/connections")
    .then((resp) => {
      let flag = false;
      let conID;
...
app.post("/offerCredential", async function (req, res) {
  ...
  axios
    .get("http://127.0.0.1:8021/credential-definitions/created")
    .then((resp) => {
  ...
  axios
    ...
    .then((resp) => {
      ...
      if (req.cookies.conID) {
        ...
        axios
          .post("http://127.0.0.1:8021/present-proof/send-request", data)
          .then((resp) => {
...
// app.listen(9999, localHostAddress, () => {
...
//   app
// )
// sslServer.listen(9999, localHostAddress, ()=> console.log('server up at SSL 9999'))
...
console.log("SSL/TLS Certificate acquired!")
